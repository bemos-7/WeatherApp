...
import com.bemos.weatherapp.presentation.screen.detail_city_future.item.ForecastDayHourItem
                    ...
                    Column {
                        Row() {
                            Image(
                                ...
                                painter = painterResource(id = IconConverter().iconConvert(forecastDay.forecastDayDomain.dayDomain.conditionDomain.text)),
